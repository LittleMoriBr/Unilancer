...
<body class="rodape">
  ...
  <div class="alinhaMenu">
    <a href="../p_LoginCliente/index.php"><button id="btoMenu">Prestador</button></a>
  </div>
  <div class="alinhaMenu">
    <a href="../p_LoginCliente/index.php"><button id="btoMenu">Empresa</button></a>
  </div>
  ...
  <div class="container-fluid backInicio" style="margin-top: -23px;">
    ...
    <div class="container-fluid p-0 bg2">
      ...
      <article class="wrapper bg10">
        <div class="marquee">
          <div class="marquee__group">
            <svg>
              <use xlink:href="img/001.png" />
            </svg>
            <svg>
