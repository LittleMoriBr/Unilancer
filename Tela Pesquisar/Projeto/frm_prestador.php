 ...
 <body>
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-7">
                    ...
                    <hr>
                    <form action="" method="post" class="form-control p-4" enctype="multipart/form-data" id="formularioPrestador">
                        <!-- NOME -->
                        <div class="row">
                            <div class="col-sm-4">
                                <div>
                        ...
                        <div><br>
                            ...
                            <button id="btoCadastrar" type="submit" class="btn btn-primary" formaction="prestador_cadastro.php">Cadastrar</button>
        ...
        <?php include_once("usuario_dataTable.php") ?>



  <script src="js/bootstrap.bundle.js"></script>
  <script src="validacoes_prestador.js"></script>
