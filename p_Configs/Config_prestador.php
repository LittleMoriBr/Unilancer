            ...
            <div class="col-sm-8 ">
                ...
                <form action="" method="post" class="form-control form-back p-4  " id="formularioPrestador">
                    ...
                    <div class="row">
                        ...
                        <!-- Recomendações -->
                        <div>
                            <label style="display:none ;" for="txtRecomendacoes">Recomendações</label>
                            <input type="text" style="display:none ;" name="txtRecomendacoes" id="txtRecomendacoes">
                        </div>

                        <!-- Avaliaçoes -->
                        <div>
                            <label style="display:none ;" for="txtAvaliacoes">Recomendações</label>
                            <input type="text" style="display:none ;" name="txtAvaliacoes" id="txtAvaliacoes">
                        </div>

                        <!-- Recomendações -->
                        <div>
                            <label style="display:none ;" for="txtRecomendacao">Recomendações</label>
